...
if (isset($_FILES['photo'])) {
  ...
  set_message('About me photo has been updated');
  header('Location: aboutme.php');
  die();
}
if (isset($_GET['id'])) {
  if (isset($_GET['delete'])) {
    ...
    set_message('About Me photo has been deleted');
    header('Location: aboutme.php');
    die();
  }
  $query = 'SELECT *
...
<?php if ($record['photo']): ?>
  ...
  <p><a href="aboutme_photo.php?id=<?php echo $_GET['id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this
      Photo</a></p>
<?php endif; ?>
